...
void demo()
{
    ...
    static std::shared_ptr<ImageButton> imageButton = GameButton::create<ImageButton>(texture, 1);
    imageButton->setPosition({ 1000, 500 });
    imageButton->onMouseMovement = [](sf::Vector2f mousePosition, sf::Vector2i mouseDelta) {
